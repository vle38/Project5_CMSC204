...
public class MorseCodeConverterTestPublic {
	...
	public void testConvertToEnglishString() {	
		String converter1 = MorseCodeConverter.convertCodeToEnglish(".... . .-.. .-.. --- / .-- --- .-. .-.. -.. ");
	...
	public void testConvertMorseFileToEnglishString() {	
		...
		*/
		...
		try {
			assertEquals("how do i love thee let me count the ways", MorseCodeConverter.convertCodeToEnglish(file));
